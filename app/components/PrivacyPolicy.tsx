      ...
      <div className="space-y-8 text-gray-700">
        ...
        <section>
          ...
          <p className="text-lg leading-relaxed">
            ...
            when you visit our website, use our services, or interact with us in
            other ways.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-lg leading-relaxed mb-4">
            We may collect personal information in various ways, including when
            you visit our website, request services, or interact with us. The
        ...
        <section>
          ...
          <p className="text-lg leading-relaxed">
            ...
            of your personal information, including encryption, firewalls, and
            secure servers. However, please note that no method of transmission
        ...
        <section>
          ...
          <p className="text-lg leading-relaxed">
            ...
            communications at any time. To exercise these rights or if you have
            any concerns about how we handle your information, please contact us
            at [your contact email or phone number].
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-lg leading-relaxed">
            ...
            responsible for the privacy practices of these third-party sites. We
        ...
        <section>
          ...
          <p className="text-lg leading-relaxed">
            ...
            posted on this page, and the effective date of the changes will be
